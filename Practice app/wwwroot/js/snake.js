...
const snakeGameOverScreen = document.getElementById('snake-game-over');
const snakeResultTitle = document.getElementById('snake-result-title');
const snakeResultMsg = document.getElementById('snake-result-msg');
const GRID_SIZE = 20;
let snake = [];
let food = { x: 0, y: 0 };
let dx = 0;
...
function drawSnakeGame(interpolation) {
    // Clear canvas
...
function drawBodyPart(x, y, index, isTail) {
    snakeCtx.fillStyle = '#2ed573';
