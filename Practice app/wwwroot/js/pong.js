...
const aiDisplay = document.getElementById('ai-score');
const pongGameOverScreen = document.getElementById('pong-game-over');
const pongResultTitle = document.getElementById('pong-result-title');
const pongResultMsg = document.getElementById('pong-result-msg');
...
function update() {
    ...
    if (playerY < 0)
        playerY = 0;
    if (playerY > pongCanvas.height - PADDLE_HEIGHT)
        playerY = pongCanvas.height - PADDLE_HEIGHT;
    // Ball movement
    ballX += ballSpeedX;
    ballY += ballSpeedY;
...
function resizeCanvas() {
    var container = document.getElementById('pong-container');
    if (container) {
