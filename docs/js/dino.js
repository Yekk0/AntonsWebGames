...
const dinoHighScoreDisplay = document.getElementById('dino-high-score');
const dinoGameOverScreen = document.getElementById('dino-game-over');
const dinoResultTitle = document.getElementById('dino-result-title');
const dinoResultMsg = document.getElementById('dino-result-msg');
const GRAVITY = 0.6;
const JUMP_FORCE = -12;
...
function updateDino() {
    ...
    for (let i = obstacles.length - 1; i >= 0; i--) {
        ...
        // Collision detection
        if (obstacles[i].x < 50 + DINO_WIDTH &&
...
function resizeDinoCanvas() {
    var container = document.getElementById('dino-container');
    if (container) {
